# Implementation of GUI form for display of textual report of pairwise alignment. (both of AA and PB sequences)
...
import datetime
from window_izbor_sa_vizuelizacije import *
from window_izbor_msa_vizuelizacije import *


# class for UI for display of textual report of pairwise alignment (both for AA and PB sequences)
...
class Ui_Form_Izvestaj_Poravnanja(object):
    def setupUi(self, Form):
        ...
        # Member fields for alignment data
        self.labels = None
        self.alignments = None
        self.reportLines = None
        self.windowViz = WidgetSAVizuelizacija()
    ...
    def clickPbVizuelizacija(self):
        ...
        self.windowViz.set_alignments(self.alignments)
        self.windowViz.set_labels(self.labels)
        self.windowViz.show()


# class for window whose UI is implemented class above
class WidgetIzvestajPoravnanja(QWidget):
    def __init__(self):
        super(WidgetIzvestajPoravnanja, self).__init__()
        self.ui = Ui_Form_Izvestaj_Poravnanja()
    ...
    def setAlignments(self, alignments):
        self.ui.setAlignments(alignments)

    def setReportLines(self, lines):
        self.ui.setReportLines(lines)

    def setLabels(self, labels):
        self.ui.setLabels(labels)